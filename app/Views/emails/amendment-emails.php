                ...
                <td colspan="2">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <th style="font-size: 14px;padding: 5px 8px;border: 1px solid gray;">Ticket No.</th>
                        </tr>
                        <?php foreach ($paxs as $key=>$pax){?>
                            <tr>
                                ...
                                <td style="font-size: 14px;padding: 5px 8px;border: 1px solid gray;"><?php echo $pax['ticket_number']?></td>
                            </tr>
                        <?php }?>
                    </table>
                </td>
