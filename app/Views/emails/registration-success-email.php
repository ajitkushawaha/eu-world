								...
								<tr>
									<td style="width: 100%; padding: 10px;">
										<div style="text-align: center;">
											<img src="<?php echo site_url('webroot/img/home-logo.png') ?>" alt="logo.png" class="CToWUd" data-bit="iit" style="margin-bottom:10px; width:250px; height: 100px; object-fit: contain;">
										</div>
