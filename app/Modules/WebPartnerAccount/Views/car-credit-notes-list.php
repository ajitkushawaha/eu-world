    ...
    <div class="page-content">
        ...
        <div class="page-content-area card-body">
            ...
            <!----------Start Search Bar ----------------->
                ...
                <form action="<?php echo site_url('webpartneraccounts/credit-notes-car'); ?>" method="GET"
                    ...
                    <div class="col-md-2 align-self-end">
                        <div class="form-group form-mb-20">
                            <button type="submit" data-url="<?php echo site_url('webpartneraccounts/credit-notes-car'); ?>"
                                    praveen-method="get"
                    ...
                    <div class="col-md-2">
                        <? if (isset($search_bar_data['key'])) : ?>
                            <div class="search-reset-btn">
                                <a href="<?php echo site_url('webpartneraccounts/credit-notes-car'); ?>">Reset Search</a>
                            </div>
                        <? endif ?>
                    </div>
                        ...
                        if (!empty($account_logs) && is_array($account_logs)) {
                            foreach ($account_logs as $data) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('/car/details/') . $data['booking_ref_number']; ?>"><?php echo $data['booking_ref_number']; ?></a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <b>Car:</b> <?php echo $data['car_name']; ?><br/>
                                        <b>Trip Type:</b> <?php echo $data['travel_types']; ?><br/>
                                        <b>Origin:</b> <?php echo $data['source']; ?><br/>
                                        <b>Destination:</b> <?php echo $data['destination']; ?><br/>
                                        <b>Departure:</b> <?php echo $data['departure_date'].' '.$data['pick_up_time']; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('car/get-credit-note?type=CreditNote&booking_ref_number=' . $data['booking_ref_number']) ?>&traveller_ref_number=<?php echo '' ?>"><i
