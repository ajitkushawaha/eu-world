<div class="content ">
	<div class="page-content">
		...
		<div class="page-content-area">
			...
			<!----------Start Search Bar ----------------->
			<form class="row g-3 mb-3" action="<?php echo site_url('webpartneraccounts/get-web-partner-account-info'); ?>" method="GET" class="tts-dis-content" name="web-partner-search" onsubmit="return searchvalidateForm()">
				...
				<div class="col-md-4 align-self-end ">
					<div class="form-group text-md-end">
						<button type="submit" class="btn_excel" onclick="exportExcel()">
							<img class="img-fluid" src="<?php echo site_url('webroot/img/excel.svg') ?>" alt="excel">
						</button>
					</div>
				</div>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td><?php echo $data['booking_confirmation_number']; ?></td>
											<td>
												<b>
													<?php
											...
											<td>
												...
												echo ucfirst($data['action_type']) . "-";
												echo  $data['payment_mode'] != "" ? "<b></b> " . $data['payment_mode'] . $transaction_id . "<br/>" : "Wallet"; ?></td>
