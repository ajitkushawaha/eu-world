    ...
    <div class="page-content">
        ...
        <div class="page-content-area card-body">
            ...
            <!----------Start Search Bar ----------------->
                ...
                <form action="<?php echo site_url('webpartneraccounts/credit-notes-visa'); ?>" method="GET"
                    ...
                    <div class="col-md-2 align-self-end">
                        <div class="form-group form-mb-20">
                            <button type="submit" data-url="<?php echo site_url('webpartneraccounts/credit-notes-visa'); ?>"
                                    praveen-method="get"
                    ...
                    <div class="col-md-2">
                        <? if (isset($search_bar_data['key'])) : ?>
                            <div class="search-reset-btn">
                                <a href="<?php echo site_url('webpartneraccounts/credit-notes-visa'); ?>">Reset Search</a>
                            </div>
                        <? endif ?>
                    </div>
                        ...
                        if (!empty($account_logs) && is_array($account_logs)) {
                            foreach ($account_logs as $data) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <b>Country:</b> <?php echo $data['visa_country']; ?><br/>
                                        <b>Type:</b> <?php echo $data['visa_type']; ?><br/>

                                        <b>Travel:</b> <?php echo $data['date_of_journey']; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('visa/get-credit-note?type=CreditNote&booking_ref_number=' . $data['booking_ref_number']) ?>&traveller_ref_number=<?php echo '' ?>"><i
