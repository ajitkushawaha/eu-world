<div class="content ">
    <div class="page-content">
        ...
        <div class="page-content-area card-body">
            <!----------Start Search Bar ----------------->
                <form action="<?php echo site_url('webpartneraccounts/credit-notes-holiday'); ?>" method="GET"
                    ...
                    <div class="col-md-2 align-self-end">
                        <div class="form-group form-mb-20">
                            <button type="submit" data-url="<?php echo site_url('webpartneraccounts/credit-notes-holiday'); ?>"
                                    praveen-method="get"
                    ...
                    <div class="col-md-2">
                        <? if (isset($search_bar_data['key'])) : ?>
                            <div class="search-reset-btn">
                                <a href="<?php echo site_url('webpartneraccounts/credit-notes-holiday'); ?>">Reset Search</a>
                            </div>
                        <? endif ?>
                    </div>
                        ...
                        if (!empty($account_logs) && is_array($account_logs)) {
                            foreach ($account_logs as $data) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <b>Package:</b> <?php echo $data['package_name']; ?><br/>
                                        <b>Type:</b> <?php echo $data['package_category']; ?><br/>

                                        <b>Travel:</b> <?php echo $data['travel_date']; ?>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('holiday/get-credit-note?type=CreditNote&booking_ref_number=' . $data['booking_ref_number']) ?>&traveller_ref_number=<?php echo '' ?>"><i
