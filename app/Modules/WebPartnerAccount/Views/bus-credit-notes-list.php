<div class="content ">
    <div class="page-content">
        ...
        <div class="page-content-area card-body">
            ...
            <form action="<?php echo site_url('webpartneraccounts/credit-notes-bus'); ?>" method="GET" class="row tts-dis-content" id="sales-export" name="markup-search" onsubmit="return searchvalidateForm()">
                ...
                <div class="col-md-2">
                    <div class="form-group form-mb-20">
                        ...
                        <select name="key" class="form-select" tts-validatation="Required" tts-error-msg="Please select search key" onchange="tts_searchkey(this,'markup-search')" tts-error-msg="Please select search key">
                ...
                <div class="col-md-2 align-self-end">
                    <div class="form-group form-mb-20">
                        <button type="submit" data-url="<?php echo site_url('webpartneraccounts/credit-notes-bus'); ?>" praveen-method="get" class="badge badge-md badge-primary export-praveen badge_search">Search <i class="fa fa-search"></i></button>
                    </div>
                </div>
                <div class="col-md-2">
                    <? if (isset($search_bar_data['key'])) : ?>
                        <div class="search-reset-btn">
                            <a href="<?php echo site_url('webpartneraccounts/credit-notes-bus'); ?>">Reset Search</a>
                        </div>
                    <? endif ?>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('/bus/details/') . $data['booking_ref_number']; ?>"><?php echo $data['booking_ref_number']; ?></a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <b>Bus:</b> <?php echo $data['bus_name']; ?><br />

                                            <b>Origin:</b> <?php echo $data['origin_city']; ?><br />
                                            <b>Destination:</b> <?php echo $data['destination_city']; ?><br />
                                            <b>Departure:</b> <?php echo $data['date_of_journey']; ?>
                                        </td>
                                        <td>
                                            <b>PNR: </b><?php echo $data['travel_operator_pnr']; ?><br />
                                            <b>TicketNo: </b><?php echo $data['ticket_no']; ?>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('bus/get-credit-note?type=CreditNote&booking_ref_number=' . $data['booking_ref_number']) ?>&traveller_ref_number=<?php echo $data['TravelerId'] ?>"><i class="fa-solid fa-eye"></i> View</a>
                                        </td>
                                    </tr>
                            <?php
                                }
