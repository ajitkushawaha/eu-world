<div class="modal-header">
 ...
 <form action="<?php echo site_url('markup-discount/add-super-admin-visa-discount'); ?>" method="post" tts-form="true" name="add_visa_markup">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group form-mb-20">
                        ...
                        <select class="form-control select_search"  tts-method-name="visa/get-visa-list-select-markup" name="visa_country_id" tts-call-select="true">
