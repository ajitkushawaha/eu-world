                    ...
                    <div class="col-md-12 settings-panel">
                        <div class="page-actions-panel">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <h5 class="m-0">Cruise Ship Gallery List</h5>
                                </div>
                                <div class="col-md-8 text-md-end">


                                    <?php if (permission_access("Cruise", "add_cruise_ship_gallery")) { ?>

                                        <button class="badge badge-wt" view-data-modal="true" data-controller='cruise' data-href="<?php echo site_url('cruise/add-cruise-ship-gallery-template') ?>">
                                            <i class="fa-solid fa-add"></i> Add Cruise Ship Gallery
                                        </button>
                                    <?php } ?>

                                    <?php if (permission_access("Cruise", "cruise_ship_gallery_status")) { ?>
                                        <button class="badge badge-wt" onclick="confirm_change_status('status_change')">
                                            <i class="fa-solid fa-exchange"></i> Change Status
                                        </button>
                                    <?php } ?>

                                    <?php if (permission_access("Cruise", "delete_cruise_ship_gallery")) { ?>
                        ...
                        <div class="col-md-12">
                            <div class="row setting-content">
                                ...
                                <!----------Start Search Bar ----------------->
                                <form action="<?php echo site_url('cruise/cruise-ship-gallery-list'); ?>" method="GET" name="cruise-gallery-search" onsubmit="return searchvalidateForm()">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group form-mb-20">
                                                <label>Select key to search by *</label>
                                                <select name="key" class="form-control" onchange="tts_searchkey(this,'cruise-gallery-search')" tts-validatation="Required" tts-error-msg="Please select search key">
                                                    <option value="">Please select</option>
                                                    <option value="cruise_line_name" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'cruise_line_name') {
                                                                                            echo "selected";
                                                                                        } ?>>Cruise Line Name
                                                    </option>
                                        ...
                                        <?php if (isset($search_bar_data['key'])) : ?>
                                            <div class="col-md-3 mb-3">
                                                <div class="search-reset-btn">
                                                    <a href="<?php echo site_url('cruise/cruise-ship-gallery-list'); ?>">Reset
                                                        Search</a>
                                                </div>
                                            </div>
                                        <?php endif ?>
                        ...
                        <div class="setting-content">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <?php $trash_uri = "cruise/remove-cruise-ship-gallery"; ?>
                                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true" id="formgallerylist">
                                        <table class="table table-bordered table-hover">
                                            <thead class="table-active">
                                                <tr>

                                                    <?php if (permission_access("Cruise", "delete_cruise_ship_gallery") || permission_access("Cruise", "cruise_ship_gallery_status")) { ?>
                                                    ...
                                                    <th>Created Date</th>
                                                    <th>Modified Date</th>
                                                    <?php if (permission_access("Cruise", "edit_cruise_ship_gallery")) { ?>
                                                        <th>Action</th>
                                                    <?php } ?>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="<?php echo root_url . "uploads/cruise/thumbnail/" . $data['images']; ?>" alt="<?php echo $data['image_title']; ?>" class="tts-blog-image">
                                                            </td>
                                                            ...
                                                            <?php if (permission_access("Cruise", "edit_cruise_ship_gallery")) { ?>
                                                                <td>
                                                                    <a href="javascript:void(0);" view-data-modal="true" data-controller='cruise' data-id="<?php echo dev_encode($data['id']); ?>" data-href="<?php echo site_url('/cruise/edit-cruise-ship-gallery-template/') . dev_encode($data['id']); ?>"><i class="fa fa-edit "></i></a>
                                                                </td>
                                                            <?php } ?>
                                                ...
                                                <?php }
                                                    ...
                                                    echo "<tr> <td colspan='11' class='text-center'><b>No Cruise Ship Gallery Found </b></td></tr>";
                                                } ?>
                                            </tbody>
                                        </table>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('cruise/cruise-ship-gallery-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
