                    ...
                    <div class="col-md-12 settings-panel">
                        <div class="page-actions-panel">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <h5 class="m0">Cruise Ship List</h5>
                                </div>
                                <div class="col-md-8 text-end">


                                    <?php if (permission_access("Cruise", "add_cruise_ship")) { ?>

                                    <button class="badge badge-wt" view-data-modal="true" data-controller='cruise'
                                            data-href="<?php echo site_url('cruise/add-cruise-ship-template') ?>">
                                        <i class="fa-solid fa-add"></i> Add Cruise Ship
                                    </button>
                                    <?php } ?>

                                    <?php if (permission_access("Cruise", "cruise_ship_status")) { ?>
                                    <button class="badge badge-wt" onclick="confirm_change_status('status_change')">
                                        <i class="fa-solid fa-exchange"></i> Change Status
                                    </button>
                                    <?php } ?>

                                    <?php if (permission_access("Cruise", "delete_cruise_ship")) { ?>
                        ...
                        <div class="col-md-12">
                            <div class="row setting-content">
                                ...
                                <!----------Start Search Bar ----------------->
                                <form action="<?php echo site_url('cruise/cruise-ship-list'); ?>" method="GET" class="tts-dis-content row mb-3 g-3"
                                      name="cruise-ship-search" onsubmit="return searchvalidateForm()">
                                    <div class="col-md-3">
                                        <div class="form-group form-mb-20">
                                            <label>Select key to search by *</label>
                                            <select name="key" class="form-control" onchange="tts_searchkey(this,'cruise-ship-search')"
                                    ...
                                    <?php if (isset($search_bar_data['key'])): ?>
                                        <div class="col-md-3 mb-3">
                                            <div class="search-reset-btn">
                                                <a href="<?php echo site_url('cruise/cruise-ship-list'); ?>">Reset Search</a>
                                            </div>
                                        </div>
                                    <?php endif ?>
                        ...
                        <div class="setting-content">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <?php $trash_uri = "cruise/remove-cruise-ship"; ?>
                                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true" id="formlist">
                                        <table class="table table-bordered table-hover">
                                            <thead class="table-active">
                                            <tr>

                                                <?php if (permission_access("Cruise", "delete_cruise_ship") || permission_access("Cruise", "cruise_ship_status")) { ?>
                                                ...
                                                <th>Created Date</th>
                                                <th>Modified Date</th>
                                                <?php if (permission_access("Cruise", "edit_cruise_ship")) { ?>
                                                <th>Action</th>
                                                <?php }?>
                                            ...
                                            if (!empty($list) && is_array($list)) {
                                                foreach ($list as $data) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo root_url . "uploads/cruise/thumbnail/" . $data['ship_image']; ?>"
                                                                 alt="<?php echo $data['ship_name']; ?>" class="tts-blog-image">
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='cruise'
                                                               ...
                                                               data-href="<?php echo site_url('/cruise/edit-cruise-ship-template/') . dev_encode($data['id']); ?>"><i
                                                ...
                                                echo "<tr> <td colspan='11' class='text-center'><b>No Cruise Ship found </b></td></tr>";
                                            } ?>
                                            </tbody>
                                        </table>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('cruise/cruise-ship-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
