...
<form action="<?php echo site_url('cruise/edit-cruise-port/' . dev_encode($id)); ?>" method="post" tts-form="true" name="add_car_city">
      ...
      <div class="row">
         ...
         <div class="col-md-4">
            <div class="form-group form-mb-20">
               ...
               <input class="form-control" type="text" name="port_name" value="<?php echo $details['port_name'] ?>">
            </div>
         </div>
         <div class="col-md-4">
            <div class="form-group form-mb-20">
