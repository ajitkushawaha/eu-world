                    ...
                    <div class="col-md-12 settings-panel">
                        <div class="page-actions-panel">
                            <div class="row align-items-center">
                                <div class="col-md-4 mb-3 mb-lg-0">
                                    <h5 class="m0">Cruise Ocean List</h5>
                                </div>
                                <div class="col-md-8 text-md-end">


                                    <?php if (permission_access("Cruise", "add_cruise_ocean")) {  ?>

                                    <button class="badge badge-wt" view-data-modal="true" data-controller='cruise'
                                            data-href="<?php echo site_url('cruise/add-cruise-ocean-template') ?>">
                                        <i class="fa-solid fa-add"></i> Add Cruise Ocean
                                    </button>
                                    <?php }  ?>

                                    <?php if (permission_access("Cruise", "cruise_ocean_status")) {  ?>
                                    <button class="badge badge-wt" onclick="confirm_change_status('status_change')">
                                        <i class="fa-solid fa-exchange"></i> Change Status
                                    </button>
                                    <?php }  ?>

                                    <?php if (permission_access("Cruise", "delete_cruise_ocean")) {  ?>
                        ...
                        <div class="col-md-12">
                            <div class="row setting-content"> 
                                ...
                                <!----------Start Search Bar ----------------->
                                <form action="<?php echo site_url('cruise/cruise-ocean-list'); ?>" method="GET" name="cruise-ocean-search" onsubmit="return searchvalidateForm()">
                                    <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group form-mb-20">
                                            ...
                                            <select name="key" class="form-control"
                                                ...
                                                <option value="ocean_name" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'ocean_name') {
                                                    echo "selected";
                                                } ?>>Ocean Name
                                                </option>
                                    ...
                                    <?php if (isset($search_bar_data['key'])): ?>
                                        <div class="col-md-3 mb-3">
                                            <div class="search-reset-btn">
                                                <a href="<?php echo site_url('cruise/cruise-ocean-list'); ?>">Reset
                                                    Search</a>
                                            </div>
                                        </div>
                                    <?php endif ?>
                        ...
                        <div class="setting-content">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <?php $trash_uri = "cruise/remove-cruise-ocean"; ?>
                                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true"
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <?php if (permission_access("Cruise", "delete_cruise_ocean") || permission_access("Cruise", "cruise_ocean_status")) { ?>
                                                ...
                                                <th>Created Date</th>
                                                <th>Modified Date</th>
                                                <?php if (permission_access("Cruise", "edit_cruise_ocean")) {  ?>
                                                <th>Action</th>
                                                <?php } ?>
                                            ...
                                            if (!empty($list) && is_array($list)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);" view-data-modal="true"
                                                               ...
                                                               data-href="<?php echo site_url('cruise/edit-cruise-ocean-template/') . dev_encode($data['id']); ?>"><i class="fa fa-edit "></i></a>
                                                        </td>
                                                        <?php } ?>
                                                ...
                                                echo "<tr> <td colspan='11' class='text-center'><b>Cruise Ocean List</b></td></tr>";
                                            } ?>
                                            </tbody>
                                        </table>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('cruise/cruise-ocean-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
