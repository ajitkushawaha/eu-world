    ...
    <div class="page-content">
            ...
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-3 mb-lg-0">
                        <h5 class="m0"> Cruise Discount</h5>
                    </div>
                    <div class="col-md-8 text-md-right">
                        ...
                        <button class="badge badge-wt" view-data-modal="true" data-controller='cruise'
                                data-href="<?php echo site_url('cruise/super-admin-cruise-discount-view') ?>"><i
        ...
        <div class="page-content-area">
            <div class="card-body">
                <div class="row mb_10">
                    <!----------Start Search Bar ----------------->
                    <form action="<?php echo site_url('cruise/super-admin-cruise-discount-list'); ?>" method="GET" class="tts-dis-content" name="markup-search" onsubmit="return searchvalidateForm()">
                        <div class="col-md-3">
                        ...
                        <? if(isset($search_bar_data['key'])): ?>
                            <div class="col-md-1">
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('cruise/super-admin-cruise-discount-list');?>">Reset Search</a>
                                </div>
                            </div>
                        <? endif ?>
                    </form>
                ...
                <div class="table-responsive">
                    <?php
                    $trash_uri = "cruise/remove-super-admin-cruise-discount";
                    ?>
                            ...
                            if (!empty($list) && is_array($list)) {
                                foreach ($list as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <?php if (permission_access("Cruise", "edit_cruise_discount")) { ?>
                                        <td>
                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='cruise' data-id="<?php echo dev_encode($data['id']); ?>" data-href="<?php echo site_url('/cruise/edit-admin-cruise-discount-template/') . dev_encode($data['id']); ?>"><i class="tts-icon edit "></i></a>
                                        </td>
                                        <?php }?>
                                    </tr>
                                <?php }
...
<div id="status_change" class="modal fade"  tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('cruise/super-admin-cruise-discount-status-change'); ?>" method="post" tts-form="true"
