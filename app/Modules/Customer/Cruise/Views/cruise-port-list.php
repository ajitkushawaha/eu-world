                    ...
                    <div class="col-md-12 settings-panel">
                        <div class="page-actions-panel">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <h5 class="m0">Cruise Port List</h5>
                                </div>
                                <div class="col-md-8 text-md-end">


                                    <?php if (permission_access("Cruise", "add_cruise_port")) {  ?>

                                    <button class="badge badge-wt" view-data-modal="true" data-controller='cruise'
                                            data-href="<?php echo site_url('cruise/add-cruise-port-template') ?>">
                                        <i class="fa-solid fa-add"></i> Add Cruise Port
                                    </button>
                                    <?php } ?>

                                    <?php if (permission_access("Cruise", "cruise_port_status")) {  ?>
                                    <button class="badge badge-wt" onclick="confirm_change_status('status_change')">
                                        <i class="fa-solid fa-exchange"></i> Change Status
                                    </button>
                                    <?php }  ?>

                                    <?php if (permission_access("Cruise", "delete_cruise_port")) {  ?>
                        ...
                        <div class="col-md-12">
                            <div class="row setting-content">
                                ...
                                <!----------Start Search Bar ----------------->
                                <form action="<?php echo site_url('cruise/cruise-port-list'); ?>" method="GET"  name="cruise-port-search" onsubmit="return searchvalidateForm()">
                                    <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group form-mb-20">
                                            <label>Select key to search by *</label>
                                            <select name="key" class="form-control"
                                                    onchange="tts_searchkey(this,'cruise-port-search')"
                                                    tts-validatation="Required"
                                                    tts-error-msg="Please select search key">
                                                <option value="">Please select</option>
                                                <option value="port_name" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'port_name') {
                                                    echo "selected";
                                                } ?>>Port Name
                                                </option>
                                    ...
                                    <?php if (isset($search_bar_data['key'])): ?>
                                         <div class="col-md-2 mb-3">
                                            <div class="search-reset-btn">
                                                <a href="<?php echo site_url('cruise/cruise-port-list'); ?>">Reset
                                                    Search</a>
                                            </div>
                                         </div>
                                    <?php endif ?>
                        ...
                        <div class="setting-content">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <?php $trash_uri = "cruise/remove-cruise-port"; ?>
                                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true"
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <?php if (permission_access("Cruise", "delete_cruise_port") || permission_access("Cruise", "cruise_port_status")) {  ?>
                                                ...
                                                <th>Created Date</th>
                                                <th>Modified Date</th>
                                                <?php if (permission_access("Cruise", "edit_cruise_port")) {  ?>
                                                <th>Action</th>
                                                <?php } ?>
                                            ...
                                            if (!empty($list) && is_array($list)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);" view-data-modal="true"
                                                               ...
                                                               data-href="<?php echo site_url('cruise/edit-cruise-port-template/') . dev_encode($data['id']); ?>"><i class="fa fa-edit "></i></a>
                                                        </td>
                                                        <?php } ?>
                                                ...
                                                echo "<tr> <td colspan='11' class='text-center'><b>Cruise Port List</b></td></tr>";
                                            } ?>
                                            </tbody>
                                        </table>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">    
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('cruise/cruise-port-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
