...
<form action="<?php echo site_url('customer/virtual-topup/' . dev_encode($details['id'])); ?>" method="post"
    tts-form="true" name="add_topup">
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label>Remark* </label>
                    <textarea class="form-control" name="remark" placeholder="Remark" rows="2"
