...
<form action="<?php echo site_url('agent/virtual-topup/' . dev_encode($details['agent_id'])); ?>" method="post"
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="action_type" class="form-select" tts-validatation="Required"
                        ...
                        <option value="depositIncentive">Deposit Incentive</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label>Remark* </label>
                    <textarea class="form-control" type="text" name="remark" placeholder="Remark" rows="2"  spellcheck="false"></textarea>
                </div>
            </div>
            <div class="col-md-12">  
