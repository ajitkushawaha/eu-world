                ...
                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                    ...
                    <table class="table table-bordered ">
                        <tbody class="lead_details">
                          ...
                          <tr>
                                <td><span class=" item-text-head"><b>Agent ID</b></span></td>
                            ...
                            <tr>
                                <td><span class=" item-text-head"><b>Agent Class</b></span></td>
                                <td><span class="item-text-value">
                            ...
                            <tr>
                                <td><span class=" item-text-head"><b>Credit Limit</b></span></td>
                                <td><span class="item-text-value">
                                        

                                        <?php if($details['credit_limit']) { echo $details['credit_limit']; } else { echo "N/A"; } ?>
                                    </span></td>
                            </tr>
                            ...
                            <tr>
                                <td><span class=" item-text-head"><b>Company Logo</b></span></td>
                                <td>
                                    <?php if ($details['company_logo']) { ?>
                                        <span class="item-text-value"><a
                                                href="<?php echo root_url . "uploads/agent/logo/" . $details['company_logo']; ?>"
                                                target="_blank"><?php echo 'View Logo'; ?></a></span>
                                    <?php } ?>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($details['gst_scan_copy']) { ?>
                                        <span class="item-text-value"><a
                                                href="<?php echo root_url . "uploads/agent/gst/" . $details['gst_scan_copy']; ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="item-text-value">
                                        <?php echo ucfirst($details['pan_holder_name']); ?>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($details['pan_scan_copy']) { ?>
                                        <span class="item-text-value"><a
                                                href="<?php echo root_url . "uploads/agent/pan-card/" . $details['pan_scan_copy']; ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($details['aadhar_scan_copy']) { ?>
                                        <span class="item-text-value"><a
                                                href="<?php echo root_url . "uploads/agent/aadhar/" . $details['aadhar_scan_copy']; ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($details['profile_pic']) { ?>
                                        <span class="item-text-value"><a
                                                href="<?php echo root_url . "uploads/agent/profile-pic/" . $details['profile_pic']; ?>"
                                                target="_blank"><?php echo 'View Profile Pic'; ?></a></span>
                                    <?php } ?>
                                </td>
                            </tr>
