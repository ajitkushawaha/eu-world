...
<form action="<?php echo site_url('agent/virtual-debit/' . dev_encode($details['agent_id'])); ?>" method="post"
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    <label>Remark* </label>
                    <textarea class="form-control" type="text" name="remark" placeholder="Remark" rows="1"
