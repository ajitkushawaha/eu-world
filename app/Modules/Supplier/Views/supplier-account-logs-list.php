    ...
    <div class="page-content">
        <div class="table_title">
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h5 class="m-0"> Supplier Account Logs</h5>
                    </div>
                    <div class="col-md-8 text-md-end">
                        <a href="<?php echo site_url('suppliers') ?>" class="badge badge-wt"><i
                                class="fa-solid fa-list"></i> Suppliers List</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <!----------Start Search Bar ----------------->
                <form action="<?php echo site_url('suppliers/supplier-account-logs/' . dev_encode($details['supplier_id'])); ?>"
                    method="GET" class="tts-dis-content" name="supplier-account-log-search"
                    onsubmit="return searchvalidateForm()">
                    <div class="row">
                    <div class="col-md-3">
                        <div class="form-group form-mb-20">
                            <label>Select key to search by </label>
                            <select name="key" class="form-select" onchange="tts_searchkey(this,'supplier-account-log-search')"
                    ...
                    <? if (isset($search_bar_data['key'])): ?>
                                ...
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('suppliers/supplier-account-logs/' . dev_encode($details['supplier_id'])); ?>">Reset
                                        Search</a>
                                </div>
                      
                    <? endif ?>
                    </div>
                    <? if (permission_access("Supplier", "export_account_logs")): ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="white-space:unset">
                                    <a href="javascript:void(0);" view-data-modal="true" data-controller='suppliers'
                                        data-href="<?php echo site_url('/suppliers/view-remark/') . dev_encode($data['id']) ?>">View</a>
