        ...
        <div class="table_title">
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h5 class="m-0"> Distributors Account Logs</h5>
                    </div>
                    <div class="col-md-8 text-md-end">
                        <a href="<?php echo site_url('distributor') ?>" class="badge badge-wt"><i
                                class="fa-solid fa-list"></i> Distributors List</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="vewmodelhed mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="vi_mod_dsc">
                                <span>Distributor Mobile No</span>
                                <span class="primary"> <b>
                ...
                <!----------Start Search Bar ----------------->
                <form action="<?php echo site_url('distributor/distributors-account-logs/' . dev_encode($details['distributor_id'])); ?>"
                    method="GET" class="tts-dis-content" name="distributor-account-log-search"
                    onsubmit="return searchvalidateForm()">
                    <div class="row">
                    <div class="col-md-3">
                        <div class="form-group form-mb-20">
                            <label>Select key to search by </label>
                            <select name="key" class="form-select" onchange="tts_searchkey(this,'distributor-account-log-search')"
                    ...
                    <? if (isset($search_bar_data['key'])): ?>
                                ...
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('distributor/distributors-account-logs/' . dev_encode($details['distributor_id'])); ?>">Reset
                                        Search</a>
                                </div>
                      
                    <? endif ?>
                    </div>
                    <? if (permission_access("Distributor", "export_account_logs")): ?>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            if (!empty($account_logs) && is_array($account_logs)) {
                                ...
                                $extraParam  =  json_decode($data['extra_param'],true);
                                    ?>
                            <tr>
                                <td>
                                    <?php echo $key + 1; ?>
                                </td>
                                <td><?php echo   isset($extraParam['booking_ref_number'])?$extraParam['booking_ref_number']:"-"?></td>
                                <td>
                                ...
                                <td style="white-space:unset">
                                    <a href="javascript:void(0);" view-data-modal="true" data-controller='distributors'
                                        data-href="<?php echo site_url('/distributor/view-remark/') . dev_encode($data['id']) ?>">View</a>
