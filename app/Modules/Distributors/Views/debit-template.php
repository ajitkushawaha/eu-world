...
<form action="<?php echo site_url('distributor/virtual-debit/' . dev_encode($details['distributor_id'])); ?>" method="post"
    tts-form="true" name="add_debit" enctype="multipart/form-data">
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="action_type" class="form-select" tts-validatation="Required"
                        ...
                        <option value="booking_debit">Booking Debit</option>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    <label>Remark* </label>
                    <textarea class="form-control" type="file" name="remark" placeholder="Remark" rows="1"
