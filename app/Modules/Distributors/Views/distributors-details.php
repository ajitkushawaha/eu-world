        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Distributor Details</button>
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <table class="table table-bordered ">
                    <tbody class="lead_details">
                        ...
                        <tr>
                            <td><span class=" item-text-head"><b>Distributor ID</b></span></td>
                        ...
                        <tr>
                            <td><span class=" item-text-head"><b>Distributor Class</b></span></td>
                            <td><span class="item-text-value">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="item-text-value"><a
                                        href="<?php echo root_url . "uploads/distributors/gst/" . $details['gst_scan_copy']; ?>"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="item-text-value"><a
                                        href="<?php echo root_url . "uploads/distributors/pan-card/" . $details['pan_card']; ?>"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="item-text-value"><a
                                        href="<?php echo root_url . "uploads/distributors/aadhar/" . $details['aadhar_scan_copy']; ?>"
