            ...
            <div class="sale_bar">
               <div class="row align-items-center">
                  <div class="col-md-4 mb-3 mb-lg-0">
                     <h5 class="m0"> Visa Booking Details (<?php echo  $bookingDetail['booking_ref_number']; ?>)</h5>
                  </div>
                  <div class="col-md-8 text-end">
                     <a class="badge badge-wt" href="<?php echo site_url('/visa/confirmation/') . $ticketData = dev_encode(json_encode(array("BookingId" => $bookingDetail['id'], "BookingToken" => $bookingDetail['tts_search_token']))); ?>">Booking Summary</a>
                  </div>
               </div>
            </div>
            <div class="row">
                           ...
                           <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                              <div class="accordion-body cart-details-borderline">
                                 <div class="row">
                                    ...
                                    <div class="col-md-4 col-xs-6 col-6">
                                       <div class="cart_info-field">
                                          <a href="<?php echo site_url('/visa/confirmation/') . $ticketData = dev_encode(json_encode(array("BookingId" => $bookingDetail['id'], "BookingToken" => $bookingDetail['tts_search_token'])));; ?>" class="">Booking Summary</a>
                                       </div>
                                    </div>
                                    <div class="col-md-4 col-xs-6 col-6">
                                       <div class="cart_info-field">
                                       ...
                                       <div class="tts-holiday-review-details">
                                          <div class="my-3">
                                             <ul class="d-flex align-items-center justify-content-between">
                                                <li>
                                                   <h6>Visa Country</h6>
                                                   <h6><?php echo $bookingDetail['visa_country'] ?> </h6>
                                                </li>
                                                <li>
                                                   <h6>Visa Type</h6>
                                                   <h6><?php echo $bookingDetail['visa_type'] ?> </h6>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                   <h6>Travel Date</h6>
                                                   <h6><?php echo $bookingDetail['date_of_journey'] ?> </h6>
                                                </li>
                                             </ul>
                                          </div>
                                       </div>
                           ...
                           <div id="" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingsix">
                              <?php if (isset($UpdateVoucher) && $UpdateVoucher) { ?>
                                 <form name="web-partner" tts-form='true'
                                    action="<?php echo site_url('visa/visa-update-voucher-info'); ?>"
                                    method="POST" id="visa-update-Voucher">
                                    <div class="row ">
                                       <div class="col-md-12">
                                    ...
                                    <div class="row ">
                                       <div class="col-md-2">
                                          <div class="form-group">
                                             ...
                                             <select class="form-select" name="supplier">
                                                ...
                                                <?php if ($visaSupplier) {
                                                   foreach ($visaSupplier as $supplier) { ?>
                                       ...
                                       <input type="hidden" name="visa_booking_id" value="<?php echo dev_encode($bookingDetail['id']);  ?>">
...
<div id="visa-raise-amendment" class="modal">
