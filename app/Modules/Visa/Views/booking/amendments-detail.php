            ...
            <div class="container-fluid p-0">
                <div class="sale_bar">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <h5 class="m-0"> Amendment Details (<?php echo $amendmentDetail['id']; ?>)</h5>
                        </div>
                        <div class="col-md-8 text-md-end">
                            <a class="badge badge-wt"
                                href="<?php echo site_url('/visa/confirmation/') . $ticketData = dev_encode(json_encode(array("BookingId" => $amendmentDetail['Booking_id']))); ?>">Booking
                                Summary</a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-item">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span class="acordian_heading">Amendment Information :
                                                <?php echo $amendmentDetail['id']; ?></span>
                                        </button>
                                                            ...
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Amendment Id :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $amendmentDetail['id']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 col-6">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Amendment Status
                                                                    :<span class="cart_info-field--detail"><span>
                                                                            &nbsp;&nbsp;<?php echo ucfirst($amendmentDetail['amendment_status']); ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 col-6">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Amendment Type :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo ucfirst($amendmentDetail['amendment_type']); ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 col-6">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Remark From User<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $amendmentDetail['remark_from_user']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 col-6">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Remark From Company
                                                                    :<span class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $amendmentDetail['remark_from_web_partner']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 col-6">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Created On :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo date_created_format($amendmentDetail['created']); ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <?php if (isset($bookingDetail['AgentInfo']) && !empty($bookingDetail['AgentInfo'])) {
                                        ...
                                        <div class="accordion-item">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#collapseAgentInfo"
                                                aria-expanded="true" aria-controls="collapseAgentInfo">
                                                <span class="acordian_heading">Company Info </span>
                                            </button>
                                            <div id="collapseAgentInfo" class="accordion-collapse collapse show"
                                                aria-labelledby="collapseWebPAgentInfo" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Company name :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $AgentInfo['company_name']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Company Id
                                                                    :<span class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $AgentInfo['company_id']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Email :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $AgentInfo['login_email']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Mobile Number :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $AgentInfo['mobile_no']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <?php if (isset($bookingDetail['CustomerInfo']) && !empty($bookingDetail['CustomerInfo'])) {
                                        ...
                                        <div class="accordion-item">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="true" aria-controls="collapseCustomerInfo">
                                                <span class="acordian_heading">Customer Info </span>
                                            </button>
                                            <div id="collapseCustomerInfo" class="accordion-collapse collapse show"
                                                aria-labelledby="collapseWebPCustomerInfo"
                                                data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title"> Customer ID :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $CustomerInfo['customer_id']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Customer Name
                                                                    :<span class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $CustomerInfo['first_name'] . " " . $CustomerInfo['last_name']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Email :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $CustomerInfo['email_id']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="cart_info-field">
                                                                <p class="cart_info-field--title">Mobile Number :<span
                                                                        class="cart_info-field--detail"><span>
                                                                            &nbsp;<?php echo $CustomerInfo['mobile_no']; ?></span></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="collapseamendmentDetail" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body cart-details-borderline">
                                                <div class="amend_details-passengers--list">
                                                    <form
                                                        action="<?php echo site_url('visa/amendment-cancellation-charge'); ?>"
                                                        ...
                                                        $FareBreakUpwep = json_decode($amendmentDetail['web_partner_fare_break_up'], true);

                                                        $offeredFare = $FareBreakUpwep['OfferedPrice'];



                                                        $publishedFare = $FareBreakUpwep['PublishedPrice'];



                                                        $Discount = $FareBreakUpwep['Discount'];

                                                        $TDS = $FareBreakUpwep['TDS'];
                                                        ?>
                                                        <div class="row">
                                                            <div class="col-sm-12 passenger_faredetail">
                                                                <div class="row">
                                                                    <div
                                                                        class="col-sm-3 col-xs-6 col-6 padd-left-amendment">
                                                                        <p class="m0">Offered Fare</p>
                                                                        <p class="price-width-left" id="offeredFare"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p class="price-width-left" id="discount"
                                                                    ...
                                                                    <div
                                                                        class="col-sm-3 col-xs-6 col-6 padd-left-amendment">
                                                                        <p class="m0">TDS</p>
                                                                        <p class="price-width-left" id="tds"
                                                                            TDS="<?php echo $TDS; ?>"> ₹
                                                                            <?php echo $TDS; ?> </p>
                                                                    </div>
                                                                    ...
                                                                    <?php if ($amendmentDetail['amendment_type'] == "cancellation" || $amendmentDetail['amendment_type'] == "full_refund") {
                                                                        ...
                                                                        <div
                                                                            class="col-sm-3 col-xs-6 col-6 padd-left-amendment">
                                                                            <p class="m0">Cancellation Charge</p>
                                                                            <p class="price-width-left">
                                                                                <input class="input-floating-label"
                                                                                    type="text" name="charge"
                                                                                    value="<?php echo $charge; ?>"
                                                                                    id="charge"
                                                                                    oninput='getFlightRefundCharges(event)'>
                                                                            </p>
                                                                        </div>
                                                                        <div
                                                                            class="col-sm-3 col-xs-6 col-6 padd-left-amendment">
                                                                            <p class="m0">Cancellation Service Charges </p>
                                                                            <p class="price-width-left">
                                                                                <input class="input-floating-label"
                                                                        ...
                                                                        <div
                                                                            class="col-sm-3 col-xs-6 col-6 padd-left-amendment">
                                                                            <p class="m0">Cancellation Charge GST </p>
                                                                            <p class="price-width-left">
                                                                                <input class="input-floating-label"
                                                                                    type="text" name="service_charge_gst"
                                                                                    value="" id="service_charge_gst"
                                                                                    readonly>
                                                                            </p>
                                                                        </div>
                                                                        <div
                                                                            class="col-sm-3 col-xs-6 col-6 padd-left-amendment">
                                                                            <p class="m0">Refund Amount </p>
                                                                            <p class="price-width-left">
                                                                                <input class="input-floating-label"
                                                                                    type="text" name="refund"
                                                                        ...
                                                                        <div
                                                                            class="col-sm-3 col-xs-6 col-6 padd-left-amendment">
                                                                            <label class="price-width-left "><input class=""
                                                                                    type="checkbox" name="tdsreturn"
                                                                                    value="yes" id="tdsreturn"
                                                                                    onclick='getFlightRefundCharges(event)'
                                                                                    <?php echo $TDSReturnIdentifierChecked; ?>>TDS Return</label>
                                                                        </div>
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php //if (permission_access("Visa", "cancellation_charge")) { ?>
                                    ...
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        <span class="acordian_heading">Cart Information :
                                            <?php echo $amendmentDetail['booking_ref_number']; ?></span>
                                    </button>
                                                    ...
                                                    <div class="col-md-3 col-xs-6 col-6">
                                                        <div class="cart_info-field">
                                                            <p class="cart_info-field--title">Booking Ref Number :<span
                                                                    class="cart_info-field--detail"><span>
                                                                        &nbsp;<?php echo $amendmentDetail['booking_ref_number']; ?></span></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 col-xs-6 col-6">
                                                        <div class="cart_info-field">
                                                            <p class="cart_info-field--title">Amount :<span
                                                                    class="cart_info-field--detail"><span>
                                                                        &nbsp;₹&nbsp;<?php echo $amendmentDetail['total_price']; ?></span></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-xs-6 col-6">
                                                        <div class="cart_info-field">
                                                            <p class="cart_info-field--title">Booking Status :<span
                                                                    class="cart_info-field--detail"><span>
                                                                        &nbsp;<?php echo $amendmentDetail['booking_status']; ?></span></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-xs-6 col-6">
                                                        <div class="cart_info-field">
                                                            <p class="cart_info-field--title">Payment Status :<span
                                                                    class="cart_info-field--detail"><span>
                                                                        &nbsp;<?php echo $amendmentDetail['payment_status']; ?></span></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-xs-6 col-6">
                                                        <div class="cart_info-field">
                                                            <p class="cart_info-field--title">Channel Type :<span
                                                                    class="cart_info-field--detail"><span>
                                                                        &nbsp;<?php echo $amendmentDetail['booking_channel']; ?></span></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-xs-6 col-6">
                                                        <div class="cart_info-field">
                                                            <p class="cart_info-field--title">CreatedOn :<span
                                                                    class="cart_info-field--detail"><span>
                                                                        &nbsp;<?php echo date_created_format($amendmentDetail['booking_created']); ?></span></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-xs-6 col-6">
                                                        <div class="cart_info-field">
                                                            <a href="<?php echo site_url('/visa/confirmation/') . $ticketData = dev_encode(json_encode(array("BookingId" => $amendmentDetail['Booking_id'])));
                                                            ; ?>"
                                                                class="">Booking Summary</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-xs-6 col-6">
                                                        <div class="cart_info-field">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="tts-holiday-review-details">
                                                        <div class="my-3">
                                                            <ul
                                                                ...
                                                                <li>
                                                                    <h6>Visa Country</h6>
                                                                    <h6><?php echo $amendmentDetail['visa_country'] ?>
                                                                    </h6>
                                                                </li>

                                                                <li>
                                                                    <h6>Visa Type</h6>
                                                                    <h6><?php echo $amendmentDetail['visa_type'] ?>
                                                                    </h6>
                                                                </li>
                                                                <li>
                                                                    <h6>No. of Travellers</h6>
                                                                    <h6><?php echo $amendmentDetail['no_of_travellers'] ?>
                                                                    </h6>
                                                                </li>
                                                                <li>
                                                                    <h6>Travel Date</h6>
                                                                    <h6><?php echo $amendmentDetail['date_of_journey'] ?>
                                                                    </h6>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div class="col-md-12 travelimp__thanku--panelHeadwrap">
                                                    <div class="table-responsive travelimp__thanku--responsivewrap">
                                                        ...
                                                        <table
                                                            class="table table-bordered table-hover travelimp__thanku--tablewrap">
                                                            ...
                                                            <tbody>
                                                                <?php if ($amendmentDetail['travellers']) {

                                                                    foreach ($amendmentDetail['travellers'] as $key => $traveller) {
                                                                                ...
                                                                                if (!empty($document)) {
                                                                                    foreach ($document as $key => $doc) { ?>
                                                                                        <span class="item-text-value"><a
                                                                                                href="<?php echo root_url . "uploads/visa_documents/" . $doc['file_name']; ?>"
                                                                                                target="_blank"><?php echo str_replace('_', ' ', ucwords($key)); ?></a></span>
                                                                                    <?php }
                                                                                }
                                                                                ?>
                                                                            </td>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="cart_info-field">
                                                        <p class="cart_info-field--title">Pax contact:<span
                                                                class="cart_info-field--detail"><span>
                                                                    <?php echo $amendmentDetail['mobile_no']; ?></span></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                if (!empty($amendmentDetail['paymentInfo']) && is_array($amendmentDetail['paymentInfo'])) {
                                                                    foreach ($amendmentDetail['paymentInfo'] as $data) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo ucfirst($data['action_type']); ?>
                                                                            </td>
                                                                            <td>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                if ($FareBreakUp) { ?>
                                                    <table class="table table-bordered table-hover">
                                                        <tr>
                                                            <th scope="row">
                                                                <?php echo $FareBreakUp['WebPMarkUp']['LabelText']; ?> :
                                                            </th>
                                                            <td
                                                                style="  padding: 10px; text-align: right; font-weight: normal; font-size:13px; border:1px solid #ccc; font-weight:bold;">
                                                                ₹ <?php echo $FareBreakUp['WebPMarkUp']['Value']; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">
                                                                <?php echo $FareBreakUp['WebPDiscount']['LabelText']; ?> :
                                                            </th>
                                                            <td
                                                                style="  padding: 10px; text-align: right; font-weight: normal; font-size:13px; border:1px solid #ccc; font-weight:bold;">
                                                                ₹ <?php echo $FareBreakUp['WebPDiscount']['Value']; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">
                                                                <?php echo $FareBreakUp['WebPDisplayMarkup']['LabelText']; ?>
                                                                :</th>
                                                            <td
                                                                style="  padding: 10px; text-align: right; font-weight: normal; font-size:13px; border:1px solid #ccc; font-weight:bold;">
                                                                ₹ <?php echo $FareBreakUp['WebPDisplayMarkup']['Value']; ?>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <?php echo $FareBreakUp['TotalAmount']['LabelText']; ?> :
                                                            </th>
                                                    ...
                                                    <?php if (isset($FareBreakUp['GSTDetails']) && $FareBreakUp['GSTDetails']) { ?>
                                                        <table class="table table-bordered table-hover">
                                                            <tr>
                                                                ...
                                                                <th>Taxable Value</th>
                                                                <th>CGST @
                                                                    <?php echo $FareBreakUp['GSTDetails']['CGSTRate']; ?>% </th>
...
<div id="holiday-raise-amendment" class="modal fade" tabindex="1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">AMENDMENTS</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <select class="form-select" name="amendment_status">
