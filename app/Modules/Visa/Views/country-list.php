            ...
            <div class="card-body">
                        ...
                        <div class="page-actions-panel">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <h5 class="m-0">Visa Country List</h5>
                                </div>
                                <div class="col-md-8 text-md-end">


                                    <?php if (permission_access("Visa", "add_country")) { ?>
                                        <button class="badge badge-wt" view-data-modal="true" data-controller='visa'
                                                data-href="<?php echo site_url('visa/add-visa-country-template') ?>">
                                            <i class="fa-solid fa-add"></i> Add Country
                                        </button>
                                    <?php } ?>

                                    <?php if (permission_access("Visa", "country_status")) { ?>
                                        <button class="badge badge-wt" onclick="confirm_change_status('status_change')">
                                            <i class="fa-solid fa-exchange"></i> Change Status
                                        </button>
                                    <?php } ?>

                                    <?php if (permission_access("Visa", "delete_country")) { ?>
                                ...
                                <!----------Start Search Bar ----------------->
                                <form action="<?php echo site_url('visa/visa-country-list'); ?>" method="GET" class="row mt-3 mb-3"
                                      name="visa-country-search" onsubmit="return searchvalidateForm()">
                                    <div class="col-md-3">
                                        <div class="form-group form-mb-20">
                                            <label>Select key to search by *</label>
                                            <select name="key" class="form-select" onchange="tts_searchkey(this,'visa-country-search')"
                                                ...
                                                <option value="country_code" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'country_code') {
                                                    echo "selected";
                                                } ?> >Code
                                                </option>
                                    ...
                                    <?php if (isset($search_bar_data['key'])): ?>
                                        <div class="col-md-3">
                                            <div class="search-reset-btn">
                                                <a href="<?php echo site_url('visa/visa-country-list'); ?>">Reset Search</a>
                                            </div>
                                        </div>
                                    <?php endif ?>
                                ...
                                <div class="table-responsive">
                                    <?php $trash_uri = "visa/remove-visa-country"; ?>
                                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true" id="formbloglist">
                                        <table class="table table-bordered table-hover">
                                            <thead class="table-active">
                                            <tr>

                                                <?php if (permission_access("Visa", "delete_country") || permission_access("Visa", "country_status")) { ?>
                                                ...
                                                <th>Created Date</th>
                                                <th>Modified Date</th>
                                                <?php if (permission_access("Visa", "edit_country")) { ?>
                                                <th>Action</th>
                                                <?php } ?>
                                            </tr>
                                            </thead>
                                            ...
                                            if (!empty($list) && is_array($list)) {
                                                foreach ($list as $data) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo root_url . "uploads/visa_documents/thumbnail/" . $data['country_image']; ?>"
                                                                 alt="<?php echo $data['country_name']; ?>" class="tts-blog-image" width="100" height="60">
                                                        </td>
                                                        ...
                                                        <td><?php echo ucfirst($data['processing_time']); ?></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='visa'
                                                               ...
                                                               data-href="<?php echo site_url('/visa/edit-visa-country-template/') . dev_encode($data['id']); ?>"><i
                                                ...
                                                echo "<tr> <td colspan='11' class='text-center'><b>No Country Found</b></td></tr>";
                                            } ?>
                                            </tbody>
                                        </table>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('visa/country-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
